...
public class TransDetailAdapter extends RecyclerView.Adapter<TransDetailAdapter.ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.adapter_trans_detail, viewGroup,false);
    ...
    public void onBindViewHolder(@NonNull ViewHolder viewHolder, final int i) {
        ...
        viewHolder.txtDescription.setText( "Harga" + detailTransaction.getPrice() + ", Jumlah: " + detailTransaction.getQty() );
